...
/**** implemented for 60/2 OOP ****/
   ...
   // public static final double DIAMOND_SPAWN_CHANCE = 0.9;
    public static final double DIAMONDBLUE_PROPORTION = 0.4;
    public static final double DIAMONDGREEN_PROPORTION = 0.5;
