 ...
 * @author SUGAR
 */
public class DiamondBlue extends Item {
    
    public DiamondBlue(double originX, double originY) {
    super(Resources.SPR_ITEM_DIAMONDBLUE, Dimensions.PROJECTILE_ITEM_DIAMOND_WIDTH, 
            Dimensions.PROJECTILE_ITEM_DIAMOND_HEIGHT, Health.PROJECTILE_ITEM_DIAMONDBLUE_DMG,
